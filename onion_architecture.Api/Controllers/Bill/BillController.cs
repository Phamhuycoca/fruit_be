...
namespace onion_architecture.Api.Controllers.Bill
{
    ...
    public class BillController : ControllerBase
    {
        ...
        public BillController(IBillService billService, IVnPayService vnPayService, IPaymentsService paymentsService,IBill_DetailRepository bill_DetailRepository, IBill_DetailService bill_DetailService, ICartRepository cartRepository)
        {
